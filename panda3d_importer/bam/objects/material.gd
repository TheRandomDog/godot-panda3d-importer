...
func parse_object_data() -> void:
	...
	ambient = datagram.decode_color()
	diffuse = datagram.decode_color()
	specular = datagram.decode_color()
	emission = datagram.decode_color()
	var shininess_or_roughness = datagram.decode_stdfloat()
