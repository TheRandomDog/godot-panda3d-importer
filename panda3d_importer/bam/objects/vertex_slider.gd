extends BamObject
class_name PandaVertexSlider
## The base BAM Object that is used for calculating dynamic verticies,
## such as those for animations.
##
## Vertex sliders are typically blended in a [PandaTransformBlendTable].
...
## Returns the static [Transform3D] value for this [PandaVertexSlider].
## [br][br]
...
func get_static_transform() -> Transform3D:
	assert(false, 'Base PandaVertexSlider.get_static_transform() called')
	return Transform3D()
